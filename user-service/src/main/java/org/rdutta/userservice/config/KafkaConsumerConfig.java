...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, OrderValidationWithUserContextDTO> consumerFactory() {
        ...
        // ✅ Trust your common DTO package
        props.put(JsonDeserializer.TRUSTED_PACKAGES, "org.rdutta.commonlibrary.dto");

        return new DefaultKafkaConsumerFactory<>(
                props,
                new StringDeserializer(),
                new JsonDeserializer<>(OrderValidationWithUserContextDTO.class, false)
        );
    }
